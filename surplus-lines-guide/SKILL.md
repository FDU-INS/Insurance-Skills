---
name: surplus-lines-guide
description: |
  Guide surplus lines insurance placement and compliance.
  TRIGGERS - Use when user needs help with surplus-lines-guide related tasks.
category: Insurance
version: 1.0
---
# surplus-lines-guide
