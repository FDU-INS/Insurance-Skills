---
name: insurance-tech-stack
description: |
  Recommend technology stacks for modern insurance agencies.
  TRIGGERS - Use when user needs help with insurance-tech-stack related tasks.
category: Insurance
version: 1.0
---
