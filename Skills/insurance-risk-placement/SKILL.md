---
name: insurance-risk-placement
description: |
  Guide risk placement strategies.
  TRIGGERS - Use when user needs help with insurance-risk-placement related tasks.
category: Insurance
version: 1.0
---
# insurance-risk-placement
## Workflow
