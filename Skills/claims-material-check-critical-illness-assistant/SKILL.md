---
name: workers-comp-guide
description: |
  Guide workers compensation compliance and claims management.
  TRIGGERS - Use when user needs help with workers-comp-guide related tasks.
category: Insurance
version: 1.0
---
# workers-comp-guide
