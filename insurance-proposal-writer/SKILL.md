---
name: insurance-proposal-writer
description: |
  Write insurance proposals for commercial accounts.
  TRIGGERS - Use when user needs help with insurance-proposal-writer related tasks.
category: Insurance
version: 1.0
---
# insurance-proposal-writer
## Workflow
